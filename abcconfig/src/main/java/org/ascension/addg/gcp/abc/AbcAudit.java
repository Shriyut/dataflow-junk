...
public class AbcAudit extends PTransform<PCollection<TableRow>, PDone> {
	...
	public PDone expand(PCollection<TableRow> rows) {
		...
		fields.add(new TableFieldSchema().setName("job_start_time").setType("TIMESTAMP").setMode("NULLABLE"));
		...
		fields.add(new TableFieldSchema().setName("job_hop").setType("STRING").setMode("NULLABLE"));
